<template>
    ...
    <CardDetailsModal :card="selectedCard" :boardMembers="boardMembers" :boardRole="boardRole" :isVisible="isCardDetailsModalVisible" @close="isCardDetailsModalVisible = false"/>
</template>
